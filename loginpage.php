...
<html >
  ...
  <div class="logmod" style="background:url('images/background.jpg');background-size:100% 100%;">
  <div class="logmod__wrapper" style="opacity:.9;">
          ...
          <form method="POST" action="register.php">
            ...
            <div class="sminputs">
              <div class="input full">
                ...
                <input class="string optional" maxlength="255" id="user-email" type="email" name="email" placeholder="Email" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input string optional">
                <label class="string optional" for="user-pw">Password *</label>
                <input class="string optional" maxlength="255" id="user-pw" placeholder="Password" size="50" type="password" name="password"/>
              </div>
              <div class="input string optional">
                <label class="string optional" for="user-pw-repeat">Repeat password *</label>
                <input class="string optional" maxlength="255" id="user-pw-repeat" placeholder="Repeat password" size="50" type="password" name="password_confirmation" />
              </div>
            </div>
